...
\end{equation}
with the variables $\bx \in \Omega \subseteq \real^3$, the position of the gyro-centre, $\vp \in \real^3$, the velocity parallel to the magnetic field lines, and $\mu$, the modified magnetic moment. The Hamiltonian $H$ will be discussed below.
...
This is the Poisson equation and in the code it is solved using a finite element method (FEM) on a B-spline basis.
